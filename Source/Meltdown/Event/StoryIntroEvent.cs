        ...
        public override void Update(World world)
        {
            ...
            switch (this.state)
            {
                case 0:
                    ...
                    this.intro1Entity.Set(new ManagedResource<Texture2DInfo, Texture2D>(new Texture2DInfo(@"gui\story\intro1")));
                ...
                case 1:
                    switch (this.inputManager.GetEvent(Keys.E))
                    {
                        case PressEvent _:
                            ...
                            this.intro2Entity.Set(new ManagedResource<Texture2DInfo, Texture2D>(new Texture2DInfo(@"gui\story\intro2")));
